...
import com.hnit.video.common.utils.HttpClientUtil;
import com.hnit.video.common.utils.JwtUtil;
import com.hnit.video.model.entity.ucenter.Member;
import com.hnit.video.ucenter.utils.ConstantPropertiesUtil;
...
public class MemberUserWechatController {
    ...
    public String callback(String code, String state) {
        ...
        if (!state.equals("nichijoux")) {
            throw new MyException("state防伪验证错误");
        }
        ...
        try {
            ...
            if (member == null) {
                ...
                if (!save) throw new MyException("微信注册失败");
