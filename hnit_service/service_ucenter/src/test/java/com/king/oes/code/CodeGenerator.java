...
public class CodeGenerator {
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/video?serverTimezone=GMT%2B8";
    private static final String JDBC_USER_NAME = "study";
    private static final String JDBC_PASSWORD = "123456789";

    private static final String OUTPUT_DIR = "/src/main/java";

    //作者
    private static final String AUTHOR = "nichijoux";

    //设置父包名
    private static final String PACKAGE_NAME = "com.zh.video";
    //设置父包模块名
    private static final String MODULE_NAME = "ucenter";
    //设置MVC下各个模块的包名
