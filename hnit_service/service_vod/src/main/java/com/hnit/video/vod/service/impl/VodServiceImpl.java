package com.hnit.video.vod.service.impl;
...
import com.hnit.video.vod.utils.ConstantPropertiesUtil;
import com.hnit.video.vod.utils.VodInitUtil;
...
public class VodServiceImpl implements VodService {
    ...
    public void batchDeleteAliVideo(List<String> videoSourceIdList) {
        try {
            ...
            e.printStackTrace();
            throw new MyException("批量删除视频失败");
        }
    }
    ...
    public String getPlayAuth(String videoId) {
        ...
        try {
            ...
            throw new MyException("获取播放凭证失败");
        }
    }
}
